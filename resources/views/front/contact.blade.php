<x-front.layout>
  ...
  <section id="hero" class="flex justify-center items-center  block-abu">
    <div class="container">
      <div class="px-4 pt-36 py-6">
        <div class="carausel-container overflow-x-hidden w-full" style="white-space:nowrap;">
          <div class="carausel-content w-full">
            <div class="flex items-center h-full w-fit">
              <p class="text-xl mb-4 text-white text-center lg:text-3xl w-fit"
                style="font-family: 'Bebas Neue', sans-serif;">
                RELAX, UNWIND, AND FEEL THE HARMONY AT JOGLO TERRACE ~ RELAX, UNWIND, AND FEEL THE HARMONY AT JOGLO
                TERRACE ~ RELAX, UNWIND, AND FEEL THE HARMONY AT JOGLO TERRACE
              </p>
            </div>
          </div>
        </div>
  ...
  <section id="body" class="flex justify-center items-center relative overflow-x-hidden">
    <div class="container">
      <div class="px-4 lg:px-24 py-8 lg:py-28">
        <div class="flex flex-wrap">
          <div class="w-full sm:w-1/2 lg:w-1/3">
            <div class="p-2 md:p-3 lg:p-4">
              <div class="h-full w-full relative getar">
                <a href="#"
                  class="w-full h-24 flex justify-evenly items-center ring-1 ring-slate-400 linear-hijau text-white"
          ...
          <div class="w-full sm:w-1/2 lg:w-1/3">
            <div class="p-2 md:p-3 lg:p-4">
              <div class="w-full h-full relative getar">
                <a href="#"
                  class="w-full h-24 flex justify-evenly items-center ring-1 ring-slate-400 linear-hijau text-white"
                  data-aos="zoom-out" data-aos-duration="1000">
                  <svg role="img" class="fill-current" width="24" height="24" viewBox="0 0 24 24"
